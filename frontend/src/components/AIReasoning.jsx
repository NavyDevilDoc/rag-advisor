...
export default function AIReasoning({ payload, accentColor }) {
      ...
      {state.status === "error" && (
        ...
        >
          ...
          <div style={{ fontSize: 12, color: "#64748b", lineHeight: 1.6 }}>
            AI reasoning unavailable right now. The deterministic analysis above is your
            recommendation — it is independently complete.
          </div>
        </div>
      )}
    </div>
...
function Skeleton({ accentColor }) {
  ...
  return (
    <>
      ...
      <div style={{ ...bar, width: "84%" }} />
      <div style={{ ...bar, width: "66%", marginBottom: 0 }} />
    </>
  );
}
